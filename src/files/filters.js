...
module.exports = {
    ...
    //keyBannedWords : (giveway)|(gift)|(nitro)|(discord)|(free)|(steam)|(birth)

    mainBannedWords : /(n[il1]tr[oо0]?)|(d[il1]?[sc][sc]?[oо0]?r[db])/g,
    mainBannedWordsRus : /(н[иi]]тр[oо0])|(д[иi][сc]к[oо0]рд)/g,

    secondaryBannedWords : /(g[il1]?ve?[wv][аa][yuу])|(g[il1]?ft)|(fr[e3е][e3е])|(st[ae3еа][ae3еа]m)|(b[il1]?rth)/g,  
    secondaryBannedWordsRus : /(р[aoао0][з3]д[aoао0]ч[aoао0])|(б[еe3]сп?л[aoао0]тн)|(п[oо0]д[aoао0]р[oо0]?)/g,

    allBannedWords : /(n[il1]tr[oо0]?)|(d[il1]?[sc][sc]?[oо0]?r[db])|(g[il1]?ve?[wv][аa][yuу])|(g[il1]?ft)|(fr[e3е][e3е])|(st[ae3еа][ae3еа]m)|(b[il1]?rth)/g,
